 ...
 */
export function DateWithToolTip(props: {
  date: Date;
}) {
  return (
    <Tooltip title={format( props.date,'EEEE, dd. MMMM. yyyy HH:mm', { locale: de }) }>
      <span>{formatDistanceToNow(props.date, { locale: de, addSuffix: true }) }</span>
    </Tooltip>
  );
}
